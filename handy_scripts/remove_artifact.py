# File adapted from Sharon Goliath by Erik Osinga
# to be used with 
# POSSUMutils/handy_scripts/remove_wrong_ionosphere_corr_from_cadc.py
...
class ObservationUpdater():
    ...
    def update(self, observation, **kwargs):
        ...
        for plane in observation.planes.values():
            ...
            print(delete_these)
            for uri in delete_these:
                print(f'Deleting {uri} from {plane.product_id}')
